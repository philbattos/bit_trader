  ...
  def index
    ...
    @chart4 = LazyHighCharts::HighChart.new('graph') do |f|
      ...
      f.series(
        ...
        data: @completed_buys.pluck("orders.executed_value, EXTRACT(MILLISECONDS FROM orders.created_at)").map {|o| [o.first.to_f, o.last] }
      )
      ...
      f.series(
        ...
        data: @completed_sells.pluck("orders.executed_value, EXTRACT(MILLISECONDS FROM orders.created_at)").map {|o| [o.first.to_f, o.last] }
