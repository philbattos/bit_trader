class Order < ActiveRecord::Base
  ...
  def self.cancel_stale_orders
    ...
    cancel_order(oldest_buy.id)  if oldest_buy  && (oldest_buy.created_at  < 10.minutes.ago) && !Contract.recent_buys?
    cancel_order(oldest_sell.id) if oldest_sell && (oldest_sell.created_at < 10.minutes.ago) && !Contract.recent_sells?
  end
